...
#[derive(Debug)]
pub struct StagePrismProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StagePrismProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StagePrism processing");
    
    let mut processor = StagePrismProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StagePrismProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StagePrismProcessor::new(false);
